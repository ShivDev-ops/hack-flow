...
export default function TriagePage() {
  ...
  const handleToggle = async (p: any) => {
    if (p.payment_verified && !window.confirm("Are you sure you want to UNVERIFY this node?")) return;
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        ...
        <div className="relative w-full md:w-96 group">
          ...
          {showSuggestions && recommendations.length > 0 && (
            <div className="absolute top-full left-0 w-full mt-2 bg-zinc-950 border border-white/10 rounded-2xl overflow-hidden z-[60] shadow-2xl">
              ...
              {recommendations.map(rec => (
                <button 
                  ...
                  onClick={() => { setSelectedTeam(rec.team_name); setSearchTerm(""); }}
                >
