...
export default function LandingPage() {
  ...
  return (
    <div className="font-sans selection:bg-secondary/30 min-h-screen bg-[#000000] text-white overflow-x-hidden relative">
      ...
      <div className="fixed inset-0 w-full h-full z-0 pointer-events-none">
        <Hyperspeed 
          ...
          islandWidth: 2,
          lanesPerRoad: 4,
          fov: 45, // Zoomed in much further
          fovSpeedUp: 100,
          speedUp: 3.5, // Much faster jump on click
          carLightsFade: 0.4,
